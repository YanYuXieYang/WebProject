/*
 * @Author: your name
 * @Date: 2021-01-28 20:20:49
 * @LastEditTime: 2021-01-29 20:36:31
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \WebProject\jigsaw_puzzle\index.js
 */
...
function gameState () {
  btn.on('click', function () {
    if (state) {
      ...
      state = false;
      randArr();//打乱数组顺序
      cellOrder(imgRandOrder);//根据乱序数据顺序排列图片
      imgCell.css({
        'cursor': 'pointer',
